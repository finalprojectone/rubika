...
This mechanism has been integrated into Bitcore-Node-Rubika which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Rubika-Project/insight-api-rubika#web-socket-api](https://github.com/Rubika-Project/insight-api-rubika#web-socket-api) 
* API: [https://github.com/Rubika-Project/insight-api-rubika#swifttx-transactions](https://github.com/Rubika-Project/insight-api-rubika#swifttx-transactions) 
...
By default, the Rubika Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rubika Core daemon:
