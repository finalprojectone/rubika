...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/finalprojectone/rubika/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Rubika Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit rubika=v${VERSION} ../Rubika/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [rubika-detached-sigs](https://github.com/finalprojectone/rubika-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/finalprojectone/rubika/releases/new) with a link to the archived release notes.
