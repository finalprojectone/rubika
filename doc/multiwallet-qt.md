...
In order to support loading of multiple wallets in rubika-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rubika.cpp.
...
Changes to rubika.cpp
----------------------
rubika.cpp is the entry point into rubika-qt, and as such, will require some minor modifications to provide hooks for
