...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Rubika features */
        {"rubika", "masternode", &masternode, true, true, false},
        {"rubika", "listmasternodes", &listmasternodes, true, true, false},
        {"rubika", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rubika", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rubika", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rubika", "masternodedebug", &masternodedebug, true, true, false},
        {"rubika", "startmasternode", &startmasternode, true, true, false},
        {"rubika", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rubika", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rubika", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rubika", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rubika", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rubika", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rubika", "mnbudget", &mnbudget, true, true, false},
        {"rubika", "preparebudget", &preparebudget, true, true, false},
        {"rubika", "submitbudget", &submitbudget, true, true, false},
        {"rubika", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rubika", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rubika", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rubika", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rubika", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rubika", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rubika", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rubika", "checkbudgets", &checkbudgets, true, true, false},
        {"rubika", "mnsync", &mnsync, true, true, false},
        {"rubika", "spork", &spork, true, true, false},
        {"rubika", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"rubika", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use rubikad, or the -server option to rubika-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> rubika-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36557/\n";
}
