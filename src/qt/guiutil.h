...
/** Utility functions used by the Rubika Qt UI.
 */
namespace GUIUtil
{
...
// Render Rubika addresses in monospace font
...
// Parse "rubika:" URI into recipient object, return true on successful parsing
