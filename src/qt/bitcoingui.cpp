                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Rubika Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rubika address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rubika: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Rubika Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rubika Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rubika"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rubika addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rubika addresses"));
    ...
    openAction->setStatusTip(tr("Open a Rubika: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rubika Core help message to get a list with possible Rubika command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Rubika Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rubika network", "", count));
}
...
{
    QString strTitle = tr("Rubika Core"); // default title
