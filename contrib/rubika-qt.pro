...
RESOURCES += src/qt/rubika.qrc src/qt/rubika_locale.qrc

TRANSLATIONS += src/qt/locale/rubika_bg.ts \
                src/qt/locale/rubika_de.ts \
                src/qt/locale/rubika_en.ts \
                src/qt/locale/rubika_es.ts \
                src/qt/locale/rubika_fi.ts \
                src/qt/locale/rubika_fr.ts \
                src/qt/locale/rubika_it.ts \
                src/qt/locale/rubika_ja.ts \
                src/qt/locale/rubika_pl.ts \
                src/qt/locale/rubika_pt.ts \
                src/qt/locale/rubika_ru.ts \
                src/qt/locale/rubika_sk.ts \
                src/qt/locale/rubika_sv.ts \
                src/qt/locale/rubika_vi.ts \
                src/qt/locale/rubika_zh_CN.ts \
                src/qt/locale/rubika_zh_TW.ts
