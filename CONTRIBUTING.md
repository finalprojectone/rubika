Contributing to Rubika Core
============================

The Rubika Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Rubika Core project, and is not to be
confused with overall Rubika Network Protocol consensus changes.

Whether a pull request is merged into Rubika Core rests with the project merge
...
Patches that change Rubika consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rubika consensus, it must have been
...
The project leader is the release manager for each Rubika Core release.
